...
./scripts/write-release-checksum.ps1 `
  -PackagePath ./out/build/windows-vs2026-release/BlackBox-0.15.0-windows-x64.zip
...
current `0.15.0` engineering build. Final release evidence must instead use the exact signed
