...
| Windows release quality | Strong locally, externally incomplete | The current local Release graph passes 312/312 tests. Long wall-clock, physical-client, signed-package, and multi-hardware diagnostic gates remain open. |
