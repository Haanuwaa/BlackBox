...
V0.24 is a pre-1.0 product build intended for x64 Windows desktop with Windows 10 22H2 or
...
The package is `out/build/windows-msvc-release/BlackBox-0.24.0-windows-x64.zip`. It includes the
