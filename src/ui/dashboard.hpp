...
struct DashboardState {
    ...
    MetricDisplayStatus disk_service_concurrency_status{MetricDisplayStatus::warming_up};
    ...
    MetricDisplayStatus memory_activity_status{MetricDisplayStatus::unsupported};
    MetricDisplayStatus scheduler_delay_status{MetricDisplayStatus::unsupported};
    MetricDisplayStatus cpu_topology_status{MetricDisplayStatus::unsupported};
    double cpu_usage{};
    ...
    double disk_service_concurrency{};
    ...
    std::uint64_t compressed_memory_bytes{};
    double memory_page_out_mib_per_second{};
    double memory_swap_in_mib_per_second{};
    double memory_swap_out_mib_per_second{};
    double memory_compression_mib_per_second{};
    double memory_decompression_mib_per_second{};
    double scheduler_delay_milliseconds{};
    std::uint32_t logical_processor_count{};
    std::uint32_t physical_processor_count{};
    ...
    double renderer_build_p95_milliseconds{};
    double renderer_present_p95_milliseconds{};
    double renderer_frame_p95_milliseconds{};
    double renderer_frame_maximum_milliseconds{};
    std::string app_performance_report_status{"Unsupported on this platform"};
