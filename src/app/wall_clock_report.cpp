...
write_wall_clock_report(const std::filesystem::path& destination,
    ...
    try {
        ...
        append(output, "incident_pre_window_seconds", report.incident_pre_window_seconds);
        append(output, "incident_post_window_seconds", report.incident_post_window_seconds);
        append(output, "history_duration_seconds", report.history_duration_seconds);
        append(output, "collect_process_paths", report.collect_process_paths);
        ...
        append(output, "unclassified_long_gaps", report.unclassified_long_gaps);
        append(output, "unclassified_skipped_samples", report.unclassified_skipped_samples);
        ...
        append(output, "timing_window_samples", report.timing_window_samples);
        append(output, "collection_lifetime_maximum_nanoseconds", report.collection_lifetime_maximum_nanoseconds);
        append(output, "jitter_lifetime_maximum_nanoseconds", report.jitter_lifetime_maximum_nanoseconds);
        append(output, "snapshot_timing_window_samples", report.snapshot_timing_window_samples);
        append(output, "snapshot_p99_nanoseconds", report.snapshot_p99_nanoseconds);
        append(output, "snapshot_lifetime_maximum_nanoseconds", report.snapshot_lifetime_maximum_nanoseconds);
        append(output, "writer_timing_window_samples", report.writer_timing_window_samples);
        append(output, "writer_p99_nanoseconds", report.writer_p99_nanoseconds);
        append(output, "writer_window_maximum_nanoseconds", report.writer_window_maximum_nanoseconds);
        ...
        append(output, "writer_failed_incidents_not_retained", report.writer_failed_incidents_not_retained);
        append(output, "writer_last_failed_capture_sequence", report.writer_last_failed_capture_sequence);
        append(output, "writer_last_failure_utc_nanoseconds", report.writer_last_failure_utc_nanoseconds);
        append(output, "writer_explicit_recoveries", report.writer_explicit_recoveries);
